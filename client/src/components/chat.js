                        ...
                        <div className="card">
                            <div className="card-body">
                                <Title />
                                    <Clock />
                                        <Users />
                                <h5><span className="fa-layers fa-fw"><i className="fas fa-comment-alt"></i><span className="fa-layers-counter" style={{ fontSize: 40 }}>{this.state.messages.length}</span></span> Public Msgs&nbsp;</h5><a className="header-link" onClick={this.sendClearMsgs}>{this.state.messagesCleared ? `Clearing...` : `Clear` }</a>
